...
export enum NavigationPath {
    ...
    hubClusterDetails = '/multicloud/hub-clusters/:id',
    clusterOverview = '/multicloud/clusters/:id/overview',
    hubClusterOverview = '/multicloud/hub-clusters/:id/overview',
    ...
    createHubCluster = '/multicloud/create-hub-cluster',
    createClusterPool = '/multicloud/create-cluster-pool',
    importCluster = '/multicloud/import-cluster',
    importHubCluster = '/multicloud/import-hub-cluster',
